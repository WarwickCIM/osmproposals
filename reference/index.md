...
- [`proposals_votes`](https://warwickcim.github.io/osmproposals/reference/proposals_votes.md)
...
- [`get_proposals_info()`](https://warwickcim.github.io/osmproposals/reference/get_proposals_info.md)
...
- [`get_voting_summary()`](https://warwickcim.github.io/osmproposals/reference/get_voting_summary.md)
