...
A data frame with 8355 rows and 5 columns, containing all the votes cast
for every tagging proposal in `proposals` marked as "Approved",
"Rejected", "Proposed" (currently consisting of 724 different
proposals). This dataset is generated by the function
