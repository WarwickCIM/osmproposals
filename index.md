...
1.  `proposals`: A data frame with 2115 rows and 30 columns, containing
    all tagging proposals from the [OSM
    ...
    to see its metadata). Last updated on 2026-03-26 16:31:24.776173.
2.  `proposals_votes`: A data frame with 8511 rows and 5 columns,
    ...
    to see its metadata). Last updated on 2026-07-27 10:26:17.289106.
